  ...
  return (
    <group position={[player.position.x, player.position.y, player.position.z]} quaternion={orientQuat}>
      <group rotation={[0, player.rotation.y, 0]} scale={[size, size, size]}>
        ...
        <group position={off("rightArm") ? [off("rightArm")!.x, off("rightArm")!.y, off("rightArm")!.z] : [0.42, 0.18, 0]} rotation={rag ? [0, 0, 0] : [swing, 0, 0.05]}>
        ...
        <group position={off("leftArm") ? [off("leftArm")!.x, off("leftArm")!.y, off("leftArm")!.z] : [-0.42, 0.18, 0]} rotation={rag ? [0, 0, 0] : [-swing, 0, -0.05]}>
          <mesh position={[0, -0.25, 0]} castShadow>
            <capsuleGeometry args={[0.1, 0.42, 6, 12]} />
            <meshStandardMaterial color={player.color} roughness={0.6} />
          </mesh>
